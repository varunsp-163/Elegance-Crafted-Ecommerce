...
import Hero2 from "../../Components/Products/Hero2";
import Hero1 from "../../Components/Products/Hero1";
const DropDown = () => {
        ...
        {open ? (
          <div>
            <ul className="flex flex-col m-2 md:ml-6 font-[400] ">
              <il>
                <input type="checkbox" />
                <span className="ml-1"> Slik</span>
              </il>
              <il>
                <input type="checkbox" />
                <span className="ml-1"> Cotton</span>
              </il>
              <il>
                <input type="checkbox" />
                <span className="ml-1"> wool</span>
              </il>
              <il>
                <input type="checkbox" />
                <span className="ml-1"> Linen</span>
              </il>
              <il>
                <input type="checkbox" />
                <span className="ml-1"> polyster</span>
              </il>
            </ul>
          </div>
        ) : (
  ...
  return (
    <>
      <div className="overflow-hidden bg-[#0F172A] md:w-screen  w-[450px] ">
        <h1 className="text-3xl font-medium text-blue-900 relative left-[40px] m-6  ">
          Our products
        </h1>
            ...
            <div>
              ...
              <div className="pagination flex justify-center mt-3 border-t-2">
                {Array.from({
                  ...
                  <button
                    className="p-2 text-center m-2 bg-purple-200  text-purple-600 w-8 h-10 hover:bg-purple-400 hover:bg:text-purple-100"
                    key={index}
